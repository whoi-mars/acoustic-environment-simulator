...
%---------------------------------------------
config.CSED_RANGE = [1500 1500]; % [1400 1600]; % [m/s]
config.DELTA_CSED = 1; % 15; % [m/s]
config.SED_ALPHA_RANGE = [0.05 0.05]; % [dB/wavelength]

%---------------------------------------------
%             Sediment Thickness
%---------------------------------------------
config.H_RANGE = [8 8]; % [5 15]; % [m]
config.DELTA_H = 1; % [m]

%---------------------------------------------
%      Basement Sound Speed + Attenuation
%---------------------------------------------
config.CB_RANGE = [1800 1800]; % [1600 2200]; % [m/s]
config.DELTA_CB = 1; % 40; % [m/s]

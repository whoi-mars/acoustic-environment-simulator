...
void  KRAKEN(int * nm, double * frq,int * nl,char *note1, double *bb, int * nc, double *ssp, char *note2, double * bsig, double *sspHS, \
...
/* kraken_(&nm,&frq,&nl,note1,bb,&nc,ssp,note2,&bsig,sspHS,clh,&rng,&nsr,zsr,&nrc,zrc,&nz,cg,cp,kr,zm,modes); */
	KRAKEN(&nm,&frq,&nl,note1,bb,&nc,ssp,note2,&bsig,sspHS,clh,&rng,&nsr,zsr,&nrc,zrc,&nz,cg,cp,kr,att,zm,modes);

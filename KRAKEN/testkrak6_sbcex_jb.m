...
ssp1= [0.000  1468.3     0.000   1.03000     0.000    0.000
           D  1468.3     0.000   1.03000     0.000    0.000];
h=11;      
b2=[0  0.0  D+h];
ssp2=[D    1445     0.000   1.6     0.0500    0.0
      D+h  1555     0.000   1.6     0.0500    0.0];


note2='A'; %%%% Bottom boundary condition
%%% bottom halfspace boundary condition 
% syntax:  Z  CP  CS  RHO  AP  AS
sspBHS=[D+h  1830     0.000   2    0.25    0.000 ];  %%% useless if note2 ~= A
...
save example_kraken_sbcex vg_krak vp_krak kr_krak phi_krak z_krak freq_krak
